...
mns init        # scaffold your project's agent home (agent/) — git-style, open
mns explain     # the 5 faculties + how graduation works (you're always in the loop)
mns inbox       # what's pending your approval · mns review to approve/reject
